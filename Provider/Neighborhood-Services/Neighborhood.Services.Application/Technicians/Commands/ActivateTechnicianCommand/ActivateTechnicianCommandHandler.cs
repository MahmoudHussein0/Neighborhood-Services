...
{
    public class ActivateTechnicianCommandHandler(ITechnicianRepository technicianRepository) : IRequestHandler<ActivateTechnicianCommand>
    {
        private readonly ITechnicianRepository _technicianRepository = technicianRepository;

        public async Task Handle(ActivateTechnicianCommand request, CancellationToken cancellationToken)
        {
